    ...
    <div>
        ...
        <ul class="app-menu">
            <li v-for="(item, index) in menu" v-bind:key="index">
                <!-- <a class="app-menu__item active" :href='item.url'><i class="app-menu__icon fa" :class="item.icon ? item.icon : 'fa-dashboard'"></i><span class="app-menu__label">{{item.name}}</span></a> -->
                <router-link class="app-menu__item" :class="curUrl === item.url.toLowerCase() ? 'active' : ''" :target="item.new_target ? '_blank' : ''" :to='item.url'>
